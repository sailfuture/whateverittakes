...
import imageBoat2 from '@/images/boat3.jpg'
import imageBoat1 from '@/images/092923_WhateverItTakes_5_1d435f_croppped.jpg'
  ...
  return (
    <Container className="group/section [counter-increment:section]">
      <div className="lg:flex lg:items-center lg:justify-end lg:gap-x-8 lg:group-even/section:justify-start xl:gap-x-20">
        ...
        <div className="mt-12 lg:mt-0 lg:w-[37rem] lg:flex-none lg:group-even/se  ction:order-first">
          <FadeIn>
            <div
...
return (
  ...
  <div className="-my-px mx-auto max-w-[76rem] bg-neutral-200">
    <GrayscaleTransitionImage
      ...
      quality={90}
      className="w-full"
      sizes="(min-width: 1216px) 76rem, 20vw"
      priority
    />
  </div>
</div>
  ...
  return (
    ...
    <div className="-my-px mx-auto max-w-[76rem] bg-neutral-200">
      <GrayscaleTransitionImage
        ...
        quality={90}
        className="w-full"
        sizes="(min-width: 1216px) 20rem, 20vw"
        priority
      />
    </div>
  </div>
  ...
  function Info() {
    return (
      <PageIntro eyebrow="About us" title="Our strength is collaboration">
        ...
        <div className="mt-10 max-w-7x1 space-y-6 text-base">
          <p>
